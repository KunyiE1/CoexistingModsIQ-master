...
#define convert_ratio_ 274.335215
#define tole 28
#define largestMass  500000
...
int TopMG_identify(std::map<std::string, std::string> & arguments) {
  try {
    ...
    //std::string diagonalInfo_file_name = arguments["diagonalInfoFileName"];

    //db_file_name: database.fasta_target
    //ori_db_file_name: database.fasta
    ...
    */
    ...
    PrsmParaPtr prsm_para_ptr_test = ga_mng_ptr->prsm_para_ptr_;
    //processDatabase("database.fasta_target_0", prsm_para_ptr_test, var_mod_ptr_vec);

...
void Argument::initArguments() {
  arguments_["oriDatabaseFileName"]="/home/kunyili/Desktop/TopMGQuant-main/realData/yeast.fasta";
  arguments_["databaseFileName"] = "";
  arguments_["databaseBlockSize"] = "1000000";
  arguments_["spectrumFileName"] = "/home/kunyili/Desktop/TopMGQuant-main/Phospho/sim_sp_diff_frac/28seed66_2/sim_ms2.msalign";
  arguments_["combinedOutputName"] = "";
  arguments_["activation"] = "FILE";
  arguments_["searchType"] = "TARGET";
//  arguments_["fixedMod"] = "/home/kunyili/Desktop/TopMGQuant-main/Phospho/UCECTMT_revised/TMT_fixed_mods.txt";
//  arguments_["fixedMod"] = "C57";
  arguments_["fixedMod"] = "";
  arguments_["ptmNumber"] = "0";
  arguments_["massErrorTolerance"] = "20";
...
void Argument::outputArguments(std::ostream &output, std::map<std::string, std::string> arguments) {
  ...
  //output << std::setw(50) << std::left << "Diagonal information file: " << "\t" << arguments["diagonalInfoFileName"] << std::endl;
...
std::string Argument::outputCsvArguments(std::map<std::string, std::string> arguments) {
  ...
  //output << "Diagonal information file:" << comma << arguments["diagonalInfoFileName"] << std::endl;
...
bool Argument::parse(int argc, char* argv[]) {
  ...
  //std::string diagonalInfo_file_name = "";
...
//        ("database-file-name", po::value<std::string>(&database_file_name)->required(), "Database file name with its path.")
        ...
        //("diagonalInfo-file-name", po::value<std::string>(&diagonalInfo_file_name)->required(), "Diagonal information file name with its path.");

    po::positional_options_description positional_options;
//    positional_options.add("database-file-name", 1);
    positional_options.add("spectrum-file-name", -1);
    //positional_options.add("diagonalInfo-file-name", -1);
...
//    arguments_["oriDatabaseFileName"] = database_file_name;
    ...
    //arguments_["diagonalInfoFileName"] = diagonalInfo_file_name;
...
bool Argument::validateArguments() {
  ...
  // if (!file_util::exists(arguments_["diagonalInfoFileName"])) {
  //   LOG_ERROR("Diagonal information file " << arguments_["diagonalInfoFileName"] << " does not exist!");
  //   return false;
  // }

...
class GraphAlignMng {
 public:
  ...
  std::unordered_map<int,PtmPtr> ptm_map_;

  std::string resultpath;
  std::string align_result_file_;
  std::string protoform_result_file_;
